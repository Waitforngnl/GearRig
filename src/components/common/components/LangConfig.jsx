...
const resources = {
  ...
  vn: {
    translation: {
      ...
      dir: "ltr",
      topHeader:
        "Siêu Sale Mùa Hè - Miễn phí vận chuyển và Giảm giá lên đến 50% cho linh kiện PC!",
      shop: "Mua Ngay",
      welcome: "Chào mừng đến với Cửa Hàng Linh Kiện PC & Gaming Gear",
      ...
      homeSections: {
        row1: {
          ...
          col2: ["PC Siêu Tốc", "Voucher giảm giá 10%", "Mua Ngay"],
        },
        row2: ["Hôm nay", "Flash Sale", "Ngày", "Giờ", "Phút", "Giây"],
      },
      ...
      itemsArray: {
        0: {
          title: "Xe Điện Trẻ Em",
          type: "Đồ chơi",
          details: "Xe điện thú vị giúp trẻ em tự do lái xe với phong cách sành điệu, mang lại nhiều giờ vui chơi giải trí.",
        },
        1: {
          title: "Máy Ảnh DSLR CANON EOS",
          type: "Công Nghệ",
          details: "Chụp những bức ảnh và video tuyệt đẹp với máy ảnh DSLR Canon chuyên nghiệp, hoàn hảo cho những người đam mê nhiếp ảnh.",
        },
        2: {
          title: "Thức Ăn Khô Cho Chó",
          type: "Tổng Hợp",
          details: "Thức ăn khô bổ dưỡng giúp thú cưng của bạn luôn khỏe mạnh và vui vẻ, được làm từ các thành phần cao cấp.",
        },
        3: {
          title: "Laptop Gaming ASUS FHD",
          type: "Công Nghệ",
          details: "Trải nghiệm hiệu năng chơi game đỉnh cao với laptop gaming ASUS FHD, trang bị đồ họa tiên tiến và trải nghiệm mượt mà.",
        },
        4: {
          title: "Bộ Sản Phẩm Curology",
          type: "Tổng Hợp",
          details: "Bộ chăm sóc da toàn diện từ Curology giúp làm sạch, dưỡng ẩm và bảo vệ làn da của bạn luôn mềm mại.",
        },
        5: {
          title: "Tay Cầm Chơi Game USB GP11",
          type: "Gaming Gear",
          details: "Nâng tầm trải nghiệm chơi game với tay cầm USB GP11 Shooter, thiết kế chắc chắn và điều khiển chính xác.",
        },
        6: {
          title: "Áo Khoác Satin Trần Bông",
          type: "Thời Trang",
          details: "Giữ ấm và thời trang với áo khoác satin trần bông, điểm nhấn hoàn hảo cho phong cách của bạn.",
        },
        7: {
          title: "Kệ Sách Mini",
          type: "Nội Thất",
          details: "Sắp xếp sách vở và đồ trang trí gọn gàng với chiếc kệ sách nhỏ này, thiết kế phù hợp cho không gian hẹp.",
        },
        8: {
          title: "Tản Nhiệt Nước CPU RGB",
          type: "Linh Kiện PC",
          details: "Giữ cho CPU của bạn luôn mát mẻ và hoạt động ổn định với tản nhiệt nước RGB, trang bị bơm hiệu suất cao và đèn LED tùy chỉnh.",
        },
        9: {
          title: "Túi Trống Gucci",
          type: "Thời Trang",
          details: "Du lịch phong cách với túi trống Gucci, chế tác từ vật liệu cao cấp mang lại độ bền và sự sang trọng.",
        },
        10: {
          title: "Áo Khoác The North",
          type: "Thời Trang",
          details: "Giữ ấm với áo khoác The North, sở hữu thiết kế bền bỉ và không bao giờ lỗi mốt.",
        },
        11: {
          title: "Tay Cầm HAVIT HV-G92",
          type: "Gaming Gear",
          details: "Tận hưởng cảm giác điều khiển mượt mà và chính xác với tay cầm HAVIT HV-G92, thiết kế cho nhiều giờ chơi game liên tục.",
        },
        12: {
          title: "Bàn Phím Cơ Có Dây AK-900",
          type: "Gaming Gear",
          details: "Gõ phím nhanh và chính xác với bàn phím AK-900, thiết kế bền bỉ và thân thiện với cổ tay.",
        },
        13: {
          title: "Màn Hình Gaming IPS LCD",
          type: "Công Nghệ",
          details: "Đắm chìm vào thế giới game với màn hình IPS LCD, mang lại hình ảnh sống động và tần số quét mượt mà.",
        },
        14: {
          title: "Ghế Công Thái Học S-Series",
          type: "Nội Thất",
          details: "Thư giãn thoải mái với ghế S-Series, thiết kế công thái học và đệm êm ái cho những giờ làm việc dài.",
        },
        15: {
          title: "Loa JBL Boombox 2",
          type: "Hàng Mới",
          details: "Trải nghiệm âm thanh bùng nổ với JBL Boombox 2, thiết kế hầm hố và pin siêu trâu để nghe nhạc cả ngày.",
        },
        16: {
          title: "Nước Hoa",
          type: "Hàng Mới",
          details: "Hương thơm pha trộn giữa gỗ trầm, hoa hồng và hương trầm, tạo nên sự sang trọng kéo dài cả ngày.",
        },
        17: {
          title: "Điện Thoại Di Động",
          type: "Hàng Mới",
          details: "Sở hữu màn hình lớn, vi xử lý mạnh mẽ và pin trâu, hoàn hảo cho cả công việc lẫn giải trí.",
        },
        18: {
          title: "Máy Chơi Game PlayStation 5",
          type: "Hàng Mới",
          details: "Phiên bản trắng đen tuyệt đẹp của PS5 hiện đã chính thức lên kệ.",
        },
        19: {
          title: "Loa Không Dây",
          type: "Hàng Mới",
          details: "Chất lượng âm thanh tuyệt đỉnh với loa không dây Amazon.",
        },
        20: {
          title: "Bộ Sưu Tập Setup Nữ",
          type: "Hàng Mới",
          details: "Các góc máy tính mang phong cách nhẹ nhàng, tinh tế dành riêng cho phái nữ.",
        },
        21: {
          title: "Giày Đá Bóng",
          type: "Hàng Mới",
          details: "Đôi giày tuyệt vời nhất cho những trận cầu của bạn, tất cả đều có tại đây.",
        },
      },
      categories: {
        general: "Tổng Hợp",
      ...
      services: {
        0: {
          value: "GIAO HÀNG TỐC ĐỘ",
          description: "Giao hàng miễn phí cho mọi đơn hàng trên 3.000.000đ",
        },

        1: {
          value: "HỖ TRỢ KHÁCH HÀNG 24/7",
          description: "Đội ngũ chăm sóc khách hàng thân thiện 24/7",
        },
        2: {
          value: "CAM KẾT HOÀN TIỀN",
          description: "Hoàn tiền ngay trong vòng 30 ngày nếu có lỗi",
        },
      },
      redButtons: {
      ...
      whiteButtons: {
        backToHomePage: "Về Trang Chủ",
        loadMore: "Tải Thêm..",
        moveAllToBag: "Chuyển Tất Cả Vào Giỏ",
        seeAll: "Xem Tất Cả",
      ...
      checkOut: {
        ...
        phone: "Số Điện Thoại",
        email: "Địa Chỉ Email",
        apartment: "Số nhà, Tòa nhà, v.v. (Tùy chọn)",
      ...
      payment: {
        ...
        number: "Số Thẻ",
        enter: "Nhập số thẻ của bạn",
        expirationDate: "Ngày Hết Hạn",
      },
      productPage: {
        relatedItems: "Sản Phẩm Tương Tự",
        colors: "Màu Sắc",
        size: "Kích Thước",
        inStock: "Còn Hàng",
        reviews: "Đánh Giá",
        ...
        1.1: "Nhập mã bưu điện để kiểm tra khu vực giao hàng",
        2: "Chính Sách Đổi Trả",
        2.1: "Miễn phí đổi trả trong 30 ngày. Xem chi tiết",
      },
      contactPage: {
        call: "Gọi Cho Chúng Tôi",
        available: "Chúng tôi trực tổng đài 24/7, 7 ngày một tuần.",
        phone: "Hotline",
        write: "Gửi Email",
        fillForm: "Điền vào biểu mẫu và chúng tôi sẽ liên hệ trong vòng 24 giờ.",
        emails: "Email hỗ trợ",
      ...
      aboutPage: {
        ...
        paragraph1:
          "Ra mắt vào năm 2015, GearRig là nền tảng mua sắm linh kiện máy tính hàng đầu tại khu vực. Được hỗ trợ bởi các giải pháp tiếp thị và dịch vụ chuyên sâu, chúng tôi tự hào phục vụ hơn 3 triệu khách hàng đam mê công nghệ.",
        paragraph2:
          "Chúng tôi cung cấp hơn 1 triệu sản phẩm công nghệ đa dạng, từ linh kiện máy tính lẻ đến các hệ thống PC cao cấp, đáp ứng mọi nhu cầu từ văn phòng đến Gaming.",
        card1: "Nhà cung cấp đang hoạt động",
        card2: "Sản phẩm bán ra mỗi tháng",
        card3: "Khách hàng truy cập thường xuyên",
        card4: "Doanh thu gộp hàng năm",
        k1: "10.5k",
        k2: "33k",
        k3: "45.5k",
        k4: "25k",
        name1: "Nguyễn Tuấn Anh",
        name2: "Trần Nam Khánh",
        name3: "Will Smith",
        name4: "Tom Hardy",
        job1: "Nhà Sáng Lập & Chủ Tịch",
        job2: "Giám Đốc Công Nghệ (CTO)",
        job3: "Giám Đốc Điều Hành (CEO)",
        job4: "Giám Đốc Sản Phẩm",
      },
      accountPage: {
        setMassage: "Cập nhật thông tin tài khoản thành công!",
        welcome: "Xin chào! ",
        home: "Trang Chủ",
        myAccount: "Tài Khoản Của Tôi",
        ManageMyAccount: "Quản Lý Tài Khoản",
        myProfile: "Hồ Sơ Của Tôi",
        addressBook: "Sổ Địa Chỉ",
        myPaymentOptions: "Tùy Chọn Thanh Toán",
        myOrders: "Đơn Hàng Của Tôi",
        myReturns: "Yêu Cầu Đổi Trả",
        myCancelations: "Đơn Hàng Đã Hủy",
        myWishlist: "Sản Phẩm Yêu Thích",
        editYourProfile: "Chỉnh Sửa Hồ Sơ",
        firstName: "Tên",
        yourFirstName: "Nhập tên của bạn",
        lastName: "Họ",
        yourLastName: "Nhập họ của bạn",
        email: "Email",
        yourEmail: "Nhập email của bạn",
        address: "Địa Chỉ",
        yourAddress: "Nhập địa chỉ của bạn",
        passwordChanges: "Thay Đổi Mật Khẩu",
      ...
      signUpPage: {
        title: "Tạo Tài Khoản",
        enter: "Vui lòng nhập thông tin bên dưới:",
        email: "Địa chỉ Email",
        password: "Mật Khẩu",
        createAccount: "Đăng Ký Khách Hàng",
        withGoogle: "Đăng ký với Google",
      ...
      Snackbar: {
        inCart: "Sản phẩm đã có trong giỏ hàng!",
        movedToCart: "Đã chuyển sản phẩm vào giỏ hàng thành công!",
        noItems: "Không có sản phẩm nào để chuyển!",
      },
      category: {
        redTitle: "Danh Mục",
        title: "Khám Phá Linh Kiện",
        categories: {
          0: "Điện Thoại",
          1: "Laptop - PC",
      ...
      deal: {
        greenTitle: "Danh Mục",
        title: "Nâng Tầm Trải Nghiệm Âm Thanh",
        days: "Ngày",
        hours: "Giờ",
        minutes: "Phút",
        seconds: "Giây",
      ...
      allProducts: {
        redTitle: "Sản Phẩm Của Chúng Tôi",
        title: "Khám Phá Các Linh Kiện Chuyên Dụng",
      ...
      featured: {
        ...
        playStation: {
          title: "Máy Chơi Game PlayStation 5",
          description: "Phiên bản trắng đen tuyệt đẹp của PS5 hiện đã có mặt tại shop.",
        },
        WomenCollections: {
          title: "Góc Setup Lofi",
          description: "Gợi ý những góc máy tính phong cách nhẹ nhàng, tinh tế cho góc làm việc.",
        },
        speakers: {
          title: "Hệ Thống Âm Thanh",
          description: "Thưởng thức chất lượng âm thanh đỉnh cao với loa không dây Amazon.",
        },
        perfume: {
          title: "Phụ Kiện Trang Trí",
          description: "Mô hình và đèn LED RGB tô điểm góc PC của bạn.",
        },
      },
      footer: {
        subscribe: "Đăng Ký Nhận Tin",
        offer: "Nhận voucher giảm giá 10% cho đơn hàng đầu tiên",
        ...
        save: "Tiết kiệm thêm 50K khi dùng App (Dành cho người mới)",
        support: "Hỗ Trợ",
        ...
        Contact: "Liên Hệ",
        copyrights: "© Bản quyền 2026 thuộc về GearRig. Bảo lưu mọi quyền.",
        allRightsReserved: "© All rights reserved",
      },
    },
  },
